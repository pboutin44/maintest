...
var arr = ['./videos', './torrent', './torrent/files', './torrent/downloaded', './torrent/converted'];
...
//app.use('/home/streaming', require('./controllers/streaming.js'));
app.use('/home/research', require('./controllers/research.js'));
