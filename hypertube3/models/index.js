...
module.exports = {
	registerConfirm: function (req, cb) {
		var register = {};
		var errorKey = ['first_name', 'email', 'email_exist',
		'last_name', 'pseudo', 'pseudo_exist', 'password', 'password_confirmation'];
...
function registerCheck(register, users, db, req, cb)
{
	...
	if (register['first_name'] == false && register['last_name'] == false
		&& register['email'] == false && register['email_exist'] == false
		&& register['pseudo'] == false && register['pseudo_exist'] == false &&
		register['password'] == false && register['password_confirmation'] == false)
	{
